...
def prediction_using_trained_model(model_path: str, file_path: str, project_id: int) -> str:
    ...
    try:
        ...
        actual_data = actual_data.sort_values(by=[actual_data.columns[0]])
        ...
        with open(model_path, "rb") as f:
            ...
            result = pd.concat([actual_coordinates, result_csv, error_csv], axis = 1)
            file_path = (os.path.join("storage","media_files","project_csv",project_id))
